# @aarondovturkel/doorman-evaluator-cloudflare-jev

Cloudflare Workers AI Jev evaluation for Doorman identity and private risk.
...
```sh
npm install @aarondovturkel/doorman-evaluator-cloudflare-jev
# pnpm add @aarondovturkel/doorman-evaluator-cloudflare-jev
# bun add @aarondovturkel/doorman-evaluator-cloudflare-jev
```
