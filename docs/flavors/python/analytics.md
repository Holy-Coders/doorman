...
Keep your existing Python analytics client. Janitor's private identity and risk assessments live in your upstream engine; configure its PostHog, Mixpanel, Segment, Amplitude or RudderStack bridge there. The Python relay intentionally receives only public browser continuity.
