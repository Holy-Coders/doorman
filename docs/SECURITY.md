...
| SEC-04 | Medium operational                        | Anonymous callers can generate repeated requests and AI calls. Unreleased mitigation: database-shared measurement quotas, call budgets, concurrency leases and recovery probes. Gateway protection, application action limits and provider billing caps remain implementer responsibilities. |
